...
<section class="page-section bg-light" id="portfolio">
        ...
        ?>
            ...
            <tr>
                    <td>Kode: </td>
                    <td><input type="text" name="mykode" value="<?php echo $row['kode'];?>"> </td>
                </tr>
                <tr>
                    <td>Nama: </td>
                    <td><input type="text" name="mynama" value="<?php echo $row['nama'];?>"> </td>
                </tr>
               
                <tr>
                    <td>Harga: </td>
                    <td>
                        <input type="text" name="myharga" value="<?php echo $row['harga'];?>"></input>
                    </td>
                </tr>
                <tr>
                    <td>Stok: </td>
                    <td>
                        <input type="text" name="mystok" value="<?php echo $row['stok'];?>"></input>
                    </td>
                </tr>
                <tr>
                    <td>
